           ...
           return menu.children.length  == 0
             ...
             return this.current!=null && this.current.name == menu.name;
                      ...
                      <nav class="animated bounceInDown" style="overflow: auto;margin-left: 9px;">
                        <div>
                          <ul class="menus">
                              <li v-for="menu of menus" :class="{menu: isMenu(menu)}"  v-if="menu.canAccess">
                                  ...
                                  <ul  v-if="show(menu)">
                                      <li v-for="submenu of menu.children"  :class="{menu: isMenu(submenu)}" v-if="submenu.canAccess">
                                          ...
                                          <ul v-if="show(submenu)">
                                              <li v-for="menu02 of submenu.children"  v-if="menu02.canAccess">
